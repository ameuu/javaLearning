...
public class Reflections {
    ...
    public static Field getField(final Class<?> clazz, final String fieldName) {  // InstantiateTransformer iParamTypes
        Field field = null;
        try {
    ...
    public static Object getFieldValue(final Object obj, final String fieldName) throws Exception {
        final Field field = getField(obj.getClass(), fieldName); // 获取
