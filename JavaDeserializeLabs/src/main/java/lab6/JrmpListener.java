...
public class JrmpListener {
    public static void main(String[] args) throws Exception{
        ...
        ActivationInstantiator registry = (ActivationInstantiator) Proxy.newProxyInstance(lab3.JrmpListener.class.getClassLoader(), new Class[]{ActivationInstantiator.class}, rih); // 通过反射
